...
export default {
    ...
    methods:{
        ...
        preview(uuid,index){
            ...
            //     method: 'post',
            //     url: cfg.base+'public'+interfaceUrl.pdfLookUp,data:JSON.stringify({uuid:uuid}),
            //     headers:{
            //         'Content-Type':'application/json'
            //     }
            //     }).then(r=>{
            //     this.url=window.URL.createObjectURL(new Blob([r.data]))
            //     this.$refs.pdf.isShow=true;
            //     this.$refs.pdf.showPDF(r.data);

            //     var img = document.createElement("img");
            //     img.src =this.url;
            //     var a = document.createElement('a');
            //     a.href = this.url;
            //     a.setAttribute('download',"a.pdf")
            //     document.body.appendChild(img);
            //     a.click()
            // })
             pdfLook(interfaceUrl.pdfLookUp,{uuid:uuid}).then(r=>{
                // this.$refs.pdf.isShow=true;
                // this.$refs.pdf.data=r
                // this.$refs.pdf.showPDF();
                this.$emit('pdfShow',r)
