<template>
   <Modal
        ...
        <ul >
         ...
         <Table :columns="columns1" :data='data1' v-if="data1.length>0" class="self" style="margin-bottom:20px"></Table>
         <!-- <Table :columns="columns2" :data='data2' v-if="columns2.length>0" class="self"></Table> -->
         <div slot="footer">
...
export default {
    ...
    methods: {
        init(obj){
            ...
            //                 props: {
            //                     row: params.row,
            //                     bodyField: this.showField.bodyTwo
            //                     }
            //                 })
            //             }
            //     })
            //     body2.forEach((obj,index)=> {
            //         that.columns2.push({
            //             title:obj.value,
            //             key:(obj.key).toUpperCase()
            //         })
