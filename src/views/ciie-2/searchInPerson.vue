<template>
    <div class="call-record">
        ...
        <Row style="margin-bottom:10px; text-align:left;margin-bottom:20px" id="wrap">       
            <span class="labelText">单位名称</span>
            <i-input class="inputText" placeholder='请输入单位名称' style='width:200px;background: black'></i-input>

            <span class="labelText">展位号</span>
            <i-input class="inputText" placeholder='请输入展位号' style='width:200px'></i-input>

            <span class="labelText">人员名称</span>
            <i-input class="inputText" placeholder='请输入人员名称' style='width:200px'></i-input>

            <span class="labelText">证件号</span>
            <i-input class="inputText" placeholder='请输入证件号' style='width:200px'></i-input>
