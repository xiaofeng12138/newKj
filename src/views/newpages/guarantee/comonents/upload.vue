                ...
                <h3>
                    ...
                    <div class="upfile" v-if="data1.length<=0">
                        ...
                        <Upload
                            ...
                            :on-exceeded-size='outSize'
                            >
                            <Button  icon="ios-cloud-upload-outline" size='large'>选择文件</Button>
...
export default {
    ...
    methods:{
           ...
           let rs= tp.indexOf(fileType);
            if(rs < 0){
                ...
                if(this.fileSize<(file.size/1024)){
                    ...
                    // this.$emit("func",this.uploadFile.fileName)
                    this.data1.push({
                        name: file.name,
        ...
        upload(){
            ...
            let _that = this
            var url = interfaceUrl.addGuarantee //文件上传地址
            if(this.filelist.length > 0){
               _that.filelist.forEach((item,index)=>{
                formdata.append('file'+index,item)
             })  
                formdata.append('guaranteeId',this.formInfo.guaranteeId);
                formdata.append('guaranteeEpName',this.formInfo.guaranteeEpName);
                formdata.append('guaranteeEpCustomsId',this.formInfo.guaranteeEpCustomsId);
                formdata.append('customsAreaCode',this.formInfo.customsAreaCode);
                formdata.append('guaranteeMode',this.formInfo.guaranteeMode);
                formdata.append('guaranteeAmount',this.formInfo.guaranteeAmount);
                formdata.append('guaranteeStartDate',this.formInfo.guaranteeStartDate);
                formdata.append('guaranteeEndDate',this.formInfo.guaranteeEndDate);
                formdata.append('fileid',this.formInfo.fileid);
                formdata.append('status',this.formInfo.status);
                formdata.append('guaranteeMechanismName',this.formInfo.guaranteeMechanismName);
        }else{
