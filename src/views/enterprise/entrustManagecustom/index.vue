<template>
    <div>
        <h1 style="padding-bottom: 20px;">委托企业传输数据</h1>
        <Row style="margin: 10px 0;">
           
            <Col span="2">
                <span class="centerSpan">受委托企业名称</span>
            </Col>
            <Col span="5">
                <Input v-model="input1" placeholder="受委托企业名称" style="width: 200px" clearable></Input>
            </Col>
            <Col span="3">
                <span class="centerSpan">受委托企业信用代码</span>
            </Col>
            <Col span="5">
                <Input v-model="input2" placeholder="受委托企业信用代码" style="width: 200px" clearable></Input>
            </Col>
            <Col span="2">
    ...
    export default {
        ...
        methods:{
            query(){
                ...
                // if(this.$route.name=='airmanageCustom'){
                //     params.air='yes'
                // }
