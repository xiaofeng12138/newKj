...
export default {
        ...
        return{
            filed:{
                head:[
                    ...
                    {key:'InvoiceType',value:'发票种类代码（1商业发票，2详细发票，3证实发票，4收妥发票，5厂商发票，6形式发票或称预开发票，7样品发票，8领事发票，9寄售发票，10海关发票，11其他发票）'},
                        ...
                        render: (h, params) => {
                            ...
                            return h('div', [
                                h('Button',{
                                    ...
                                    on:{
                                        click(){
                                            that.getdetail(params.row.INVOICENO,params.row.SELLERCOMPANYCODEVAT)
                                        }
                                    }
                                },'查看'),
                                h(Tablepdf,{
                                ...
                                h('Poptip', {
                                    ...
                                    nativeOn:{
                                       click(e){
                                           ...
                                           if(text==='确定'||text==='ok'){
                                               that.cancel(params.row.INVOICENO,params.index,params.row.SELLERCOMPANYCODEVAT)
                                           }
    ...
    methods:{
        ...
        getdetail(id,vat){
            publicInter(interfaceUrl.InvoiceDetail,{invoiceNo:id,sellerCompanyCodeVAT:vat}).then(r=>{
                // this.$refs.selfModal.modal=true
                // this.$refs.selfModal.content=r
                // this.$refs.selfModal.data1=r.BodyDetail
                this.$emit('showDetail',{title:'发票详情',data:r,key:this.filed})
            })

        },
        cancel(id,index,vat){
            publicInter(interfaceUrl.delInvoice,{invoiceNo:id,sellerCompanyCodeVAT:vat}).then(r=>{
                if(r&&r.code==='200'){
