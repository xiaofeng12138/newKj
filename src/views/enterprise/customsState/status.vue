...
export default {
  ...
  methods: {
    ...
    async search () {
      ...
      let res = this.costomSearch({declareNum: this.inputedValue, blnum: this.billVale}) //221020181000007008
      res.then(r=>{
          if(r.code == '400'){
  ...
  computed: {
    ...
    // watch:{
    //   list(oldValue,nowValue){
    //       console.log(oldValue);
    //       console.log(nowValue);
    //       if(nowValue[0]['code'] == '400'){
    //           this.$Message.error(nowValue.err);
    //       }
    //   }
    // }
}
