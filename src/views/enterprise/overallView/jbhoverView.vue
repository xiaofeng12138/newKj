  ...
  <div class="quanjing">
    <div class="header">
        <Row style="margin-bottom:20px;text-align:left" class="searchRow">
            <span class="labelText" style='color:#fff'>提单号:</span>
            <Input v-model="inputedValue" size='large' class="customInput" style="width:200px;margin-right:12px;" disabled />
            <Button type="primary" size='large' @click="goback" style='float:right'>返 回</Button>
        </Row> 
...
import LineLength from './lineLength.vue'
import Curve1 from './curve-1.vue'
import Curve4 from './curve-4.vue'
import Curve3 from './curve-3.vue'
import Curve2 from './curve-2.vue'
import { mapActions, mapGetters, mapState } from 'vuex'
import Line2Length from './line2Length.vue'
...
export default {
  ...
  mounted () {
          this.inputedValue = this.$route.params.number;
          // this.inputedValue='COSU6271072070'
