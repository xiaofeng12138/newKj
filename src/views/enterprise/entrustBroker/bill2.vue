<template lang="html">
    <div>
        <h1 style="margin-bottom: 20px"><span v-if='airTitle'>空运</span>委托报关行提单</h1>
...
<script>
    ...
    import myTooltip2 from '@/components/guibing/myTooltip2'
    ...
    export default {
        ...
        created(){
            this.role=getCookie('roler').indexOf("EP") !== -1?'EP':'CB'
            console.log(getCookie('roler'),this.role)
        },
        mounted(){
            this.setTitle()
        ...
        methods:{
            ...
            query(){
                ...
                var url=interfaceUrl.queryBLList;
                if(this.$route.name=='airbaoguanBill'){
                    params.air='yes';
                    url=interfaceUrl.queryAirTranBLList;
                }
