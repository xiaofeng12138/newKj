<template>
    <div>
        <h1 style="padding-bottom: 20px;">处理委托</h1>
        <Row style="margin: 10px 0;">
            ...
            <!--</Col>-->
            <!--<Col span="5">-->
                <!--<DatePicker type="daterange" v-model="entrustDate" placement="bottom-start" placeholder="委托时间" style="width: 200px">-->
                <!--</DatePicker>-->
            <!--</Col>-->
            <Col span="2">
...
export default {
            ...
            return h("div", [
              ...
              h(
                "Button",
                {
                  ...
                  style: {
                    marginRight: "5px"
                    //display:((parseInt(params.row.STATUS)  || params.row.STATUS=='null' ) < 2? 'inline-block':'none'),
                  },
                  on: {
                    click: () => {
                      this.$router.push({
                        ...
                        params: {
                          ...
                          transmode: params["row"]["TRANSMODE"],
                          role: "ROLE_CB", //报关行,
  ...
  methods: {
    ...
    needDealquery() {
      ...
      publicInter(interfaceUrl.cusBroGetBLList, params).then(r => {
        if (r && r.result) {
          this.data1 = r.result;
        }
      });
    ...
    batchSubmitFun(paramsArray) {
      ...
      publicInter(interfaceUrl.changeBLToCustomsBrokerStatuscb, params).then(
        r => {
          if (r && r.result) {
