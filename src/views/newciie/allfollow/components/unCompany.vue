...
export default {
  ...
  methods:{
    ...
    exporeTrade(){
            let expoYearStatistics =  this.queryparams.expoYearStatistics
            let url = interfaceUrl.downloadAfterExhibitsStatisticsUnHandle+'?expoYearStatistics='+ expoYearStatistics +'&condition=6'
