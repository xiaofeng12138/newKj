...
<div>
     <div class="query">
            <div class="endTime">申报日期：<DatePicker size="large"  transfer type="date" @on-change="queryparams.startTime = $event" v-model='endTime1' placeholder="请选择日期" ></DatePicker></div>
            <div class="endTime">展馆号：
                 <Select v-model="queryparams.hallno" style="width:180px" >
             ...
             <div class="endTime"> 贸易方式：<Select style="width:60%" v-model="queryparams.monitormethod"><Option value="">全部</Option><Option value="0">非ATA暂进</Option> <Option value="1"> ATA单证</Option></Select></div>
               ...
               <!-- <Button type="primary" size='large' @click="exporeTrade" :disabled="isdisabled1">导出Excel</Button> -->
                <Button type="primary" size='large' @click="exporeTrade" >导出Excel</Button>
           </div>
...
export default {
  ...
  methods:{
    ...
    queryInfoList(page){
        ...
        publicInter(interfaceUrl.groupExhibitBasicInfo,requsetData).then(res=>{
               this.data1 = res.list
    ...
    exporeTrade(){
            ...
            let url = interfaceUrl.expoGroupExhibitBasicInfoExcel
