    ...
    methods:{
        ...
        */
        ...
        clickArea(key){
            ...
            data.forEach(item=>{
                this.getAllZjdata.forEach((ele)=>{
                    if(key == 'B$R'){
                        if(ele.COUNTRY == item.value && ele.STATISTIC_TYPE == 3 ){
                            item.selected=true
                      }
                    }else{
                       if(ele.COUNTRY == item.value && ele.CONTINENT == key ){
                        item.selected=true
                     }
                    }
                })
