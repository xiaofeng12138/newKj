            ...
            publicInter(interfaceUrl.qryTotalFlow,{}).then(r=> {
                ...
                if (r) {
                  //let data = r.data;
                   ...
                   this.I = (r.ylist3[0].A / 10000).toFixed(2);
                   this.J = (r.ylist3[0].B / 10000).toFixed(2);
                   this.K = (r.ylist3[0].C / 10000).toFixed(2);
                   this.L = (r.ylist3[0].D / 10000).toFixed(2);
                    ...
                    let options1 = {
                        ...
                        series:[
                            ...
                            },
                            {
                                ...
                                barWidth:30,
                                // data:this.deathData?deathData2:data2
                                 data: [this.I,this.J,this.K,this.L]
                            }
                        ]
                    }
