<template>
<div class="myRisk">
    <h2 style="font-family:SimSun;margin-bottom:10px;" v-if="tempRole==='ROLE_EB'">试吃试用补申请</h2>
    <h2 style="font-family:SimSun;margin-bottom:10px;" v-if="tempRole==='ROLE_DA'">品尝试用散发申请打印</h2>
    <p>未做正式申请的证明函可在此功能补做申请，并打印作业单交给海关作业窗口审批。</p>
    <Row class="myRiskRow" v-if="tempRole==='ROLE_EB'">
    ...
    <Row class="myRiskRow" v-if="tempRole==='ROLE_DA'">
        <Col span=7 class="item">
            <Col span=8 class="itemLabel">
                <span>展商名称:</span> 
            </Col>
            <Col span=16>
                <Input placeholder="请输入展商名称" v-model="params2.exhibitor" size="large"></Input>
            </Col>
        </Col>
        <Col span=7 class="item">
            <Col span=8 class="itemLabel">
            ...
            <Col span=16>
                <Input placeholder="请输入展台号" v-model="params2.boothno" size="large"></Input>
            </Col>
        </Col>       
        <Col span=7 class="item" >
            <Col span=8 class="itemLabel">
            ...
            <Col span=16>
                <Input placeholder="请输入物资证明函编号" v-model="params2.certificateno" size="large"></Input>
            </Col>
        </Col>
    </Row>
    <Row class="myRiskRow" v-if="tempRole==='ROLE_DA'">
        <Col span=7 class="item">
            ...
            <Col span=16>
                <Select v-model="params2.isApplied">
        ...
        <Col span=7 class="item">
            ...
            <Col span=16>
                <Select v-model="params2.proveType">
        ...
        <Col span=7 class="item">
            ...
            <Col span=16>
                <Select v-model="params2.isExamined">
    ...
    <Table border :columns='columns' ref="selection" :data='tableLits'  class="self"  style='margin:20px 0' ></Table>
    ...
    methods:{
        ...
        query(pageNum){
            ...
            if(this.tempRole==='ROLE_DA'){
                ...
                req = this.params;
                url = interfaceUrl.queryMaterialsExamineForEdit;
            }
                ...
                if(r){
                    if(r.code === '200'){
                        ...
                        setTimeout(function(){
                            ...
                            // let scs = require('./unit/print.scss');
                            // console.log(scs);
