    ...
    <div class="myIndex myIndex1" v-bind:class="{printCss:isPrintCss}">
        ...
        <div class="tablePane">
            <Row class="row row1">
                ...
                <Col span="7"  style="overflow: visible">
                ...
                <Col span="3"  :class="{centerSpan:true,needStar:!disableStatus && basis.transportmode==='2'}">运输工具</Col>
                <Col span="4">
                ...
                <Col span="3"   :class="{centerSpan:true,needStar:!disableStatus}">进境日期</Col>
                <Col span="3" style="overflow: visible">
            ...
            <Row class="row">
                ...
                <Col span="7">
                    <div v-if="disableStatus" style="word-wrap: break-word; word-break: break-all;">{{basis.billno}}</div>
                ...
                <Col span="3"  :class="{centerSpan:true,needStar:!disableStatus}">展会编号</Col>
                <Col span="4">
                    <div v-if="disableStatus">{{ basis.certexbno }}</div>
                    <Input v-else v-model="basis.certexbno" :disabled="disableStatus" placeholder='请填写展会编号'  />
                </Col>
                <Col span="3"  :class="{centerSpan:true,needStar:!disableStatus}">毛重(Kg)</Col>
                <Col span="3">
            ...
            <Row class="row">
                ...
                <Col span="14">
                    ...
                    <RadioGroup v-else v-model="basis.monitormethod" :disabled="disableStatus" @on-change='changeMonitorMethod'>
                ...
                <Col span="3"  :class="{centerSpan:true,needStar:!disableStatus}">数量(件数)</Col>
                <Col span="3">
            ...
            <Row class="row">
                ...
                <Col span="3" class="centerSpan">十位编码</Col>
                <Col span="3"> 
            ...
            <Row class="row" style="z-index: 2;">
                ...
                <Col span="3" :class="{centerSpan:true,needStar:!disableStatus}">十位编码</Col>
                <Col span="3">
            ...
            <Row class="textRow row">
                    ...
                    <p class="pBreak">兹证明此票货物为{{titleDate}}中国国际进口博览会物资，仅用于该展会。国家会展中心
