                ...
                <div class="borderLayout borderLayout2">
                    <div class="screen">
                        <div class="flowSlider" :class="{realFlow:realFlow}">
                            ...
                            <div>
                                <span class="littleTitle"><span @click="realFlow=false">流向预测</span>展品实际流向</span>
                                <bar-chartt  id="barCharts" :deathData='true' :height='barHeight' :width='barWidth'></bar-chartt>
                            </div>
                        </div>
                    </div> 
...
import exhititionList from './components/exhitionList'
import { publicInter } from '@/api/http'
import vague from './components/vague2'
import country from '@/until/corresponding';
import customsUnit from './components/customsUnit'
import ataUnit from './components/ATAUnit'
import viewIndex from './components/viewIndex'
import axios from 'axios';
import bondUnit from './components/bondUnit'
import transport from './components/leftFirst'
import sipgUnit from './components/sipgUnit'
import barChart from './components/leftSecond'
import importDynamic from './components/importDynamic' //每日进口动态
import lesChart from './components/rightSecond'
import listAndFlow from './components/listAndFlow' //展品明细及流向监控
import importExhibition from './components/importExhibition'
import exhibitMap from './components/centerFirst'
import numOver from './components/numOver'
import goodsDetail from './components/goodsDetail'
import  barChartt from './components/leftThree'

export default {
    name: "dynamic",
    components: {exhibitiontable, rotate,vague,customsUnit,ataUnit,viewIndex,transport,sipgUnit,
        bondUnit,barChart,importDynamic,lesChart,listAndFlow,importExhibition,exhibitMap,numOver,barChartt,
        goodsDetail},
    data(){
        return{    
            realFlow:false,        
