...
export default {
    ...
    return {
      ...
      filed: {
        head: [
          ...
          {
            key: "ShipperCompanyCode",
            value: "境内装箱集装箱货车公司企业代码"
          },
            ...
            return h("div", [
              h(
                "Button",
                {
                  ...
                  on: {
                    click() {
                      that.getdetail(params.row.INVOICENO);
                    }
                  }
                },
                "查看"
  ...
  methods: {
    ...
    getdetail(id) {
      publicInter(interfaceUrl.InboundDetail, { invoiceNo: id }).then(r => {
