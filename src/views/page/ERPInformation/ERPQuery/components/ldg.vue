...
export default {
    ...
    return {
      filed: {
        head: [
          ...
          {
            key: "ShipperCountryCodeISO",
            value: "境外装箱集装箱货车公司国家ISO代码"
          },
          {
            key: "ShipperCountryCodeZH",
            value: "境外装箱集装箱货车公司国家代码（中国海关标准）"
          },
          { key: "ForwardingAgent", value: "货代公司名称" },
          { key: "ForwarderVATno", value: "境外货代公司企业VAT代码" },
          {
            key: "ForwarderCountryCodeISO",
            value: "国家ISO代码(境外货代公司所在国)"
          },
          {
            key: "ForwarderCountryCodeZH",
            value: "境外货代公司所在国家代码（中国海关标准）"
          }
        ],
        bodyHead: {
          body1: [
                  ...
                  on: {
                    click() {
                      that.getdetail(
                        ...
                        params.row.CONTAINERNO,
                        params.row.SELLERCOMPANYCODEVAT,
                        params.row.SELLERCOUNTRYISOCODE
                      );
                    }
                  }
                },
  ...
  methods: {
    ...
    getdetail(invoice, container, vat, code) {
      publicInter(interfaceUrl.SellerPkgDetail, {
        invoiceNo: invoice,
        containerNo: container,
        sellerCompanyCodeVAT: vat,
        sellerCountryISOCode: code
      }).then(r => {
    ...
    cancel(invoice, container, vat, code, index) {
      publicInter(interfaceUrl.delSellerPkg, {
        invoiceNo: invoice,
        containerNo: container,
        sellerCompanyCodeVAT: vat,
        sellerCountryISOCode: code
