  ...
  methods: {
    getBoxList() {
      if (this.vsl_nme && this.arr_ext_voy_ref) {
        publicInter(interfaceUrl.queryShipChartCntr, {
          vsl_nme: this.vsl_nme,
          arr_ext_voy_ref: this.arr_ext_voy_ref
        }).then(r => {
    ...
    getDetaile(id) {
      publicInter(interfaceUrl.queryShipChartDetail, { bayplan_uuid: id }).then(
        r => {
          if (r) {
            this.modal = true;
            this.data1 = r.datas;
