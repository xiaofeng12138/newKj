<template>
    <div class="pageBreakBefore myIndex myIndex2" v-bind:class="{printCss:isPrintCss}">
        ...
        <h2 v-if="detailLength" style="margin-bottom: 10px">List of Overseas Exhibits 2018年首届中国国际进口博览会进境物资清单</h2>
        <div class="tablePane" style="margin-bottom: 20px">
            <Row v-if="!isPrintCss" style="text-align: left;margin:10px 0;color:#fff" :class="{inputHasBorder:true,needStar:!disableStatus}">展品类别：
                <Select v-model="basis2.exhtype" class="customSelect" style="width:200px" placeholder="请选择展品类别(必选)" >
            ...
            <Row class="row row1" style="color:#fff">
                <Col span="12">
                    Company公司:
            ...
            <Row class="row" style="color:#fff">
                ...
                <Col span="12">
                    Email电邮:
                    <div style="display: inline-block;width:calc(100% - 90px)"  v-if="disableStatus">{{ basis2.email }}</div>
                    <Input v-else v-model="basis2.email"   style="width: calc(100% - 90px)" placeholder="请填写电邮"></Input>
                </Col>
            </Row>
        </div>
        <div class="tablePane" style="color:#fff">
            ...
            <Row type="flex" class="row row2" style="margin-bottom: 20px;">
                ...
                <Col v-else span="4" style="overflow: visible" >
                    <div>
                        <Select multiple v-model="basis2.hallnoArr" style="width:100%;height: 32px">
                            <Option v-for="item in positionList" :value="item.NAME" :key="item.NAME">{{item.NAME }}</Option>
                        </Select>
                    </div>
                </Col>
                <Col span="2" :class="{needStar:!disableStatus}">
            ...
            <Table :columns="detailColumns" :data="basisBody" border class="customTable" width="100%"></Table>
            <!-- 打印时候的位置 -->
            ...
            allSum:function(){
                try{
                    ...
                    for(let i = 0; i < this.basisBody.length; i++){
                        ...
                        sum.totalprice += parseFloat(this.basisBody[i].totalprice ||0);
                    }
