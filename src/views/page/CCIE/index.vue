<template>
    <div class="homePage">
        <div class="head">
                  ...
                  <li @click="routeJump($event,'0')">
                        ...
                        <ol class="subMenu">
                            ...
                            <li>
                             ...
                             <li>
                                <div class="subTitle" ><img class="itemIcon" src="@/assets/qietu/dropMenu/zhgk.svg" alt="">往届对比</div>
                             ...
                             <!-- <li>
                                <router-link to='/CCIE/jy'>
                                    <img class="itemIcon" src="@/assets/qietu/dropMenu/qhjg.svg" alt="">海关监管与服务
                                </router-link>
                            </li> -->
                           
                            
                             <!-- <li>
                                <div class="subTitle"><img class="itemIcon" src="@/assets/qietu/dropMenu/zzxg.svg" alt="">溢出效应</div>
                                <ol class="subMenuItem">
                                    <li>
                                        <router-link to='/CCIE/fruitEntry'>
                                           各国水果加快入境
                                        </router-link>
                                    </li>
                    ...
                    <li @click="routeJump($event,'1')">
                        ...
                        <ol class="subMenu">
                           <li>
                            ...
                            <!-- <li>
                                <a href='https://expo.lines.coscoshipping.com/expo/home' target="_blank">
                                    <img class="itemIcon" src="@/assets/qietu/dropMenu/yxdc.svg" alt="">优享订舱
                                </a>
                            </li> -->
                            <li>
                    ...
                    <li @click="routeJump($event,'2')" class="lastli">
                          ...
                          <li>
                                ...
                                <ol class="subMenuItem">
                                    ...
                                    <li>
                                     ...
                                     <li>
                                        <router-link to='/CCIE/ciieEntryQua'>
                                            <img class="itemIcon" alt="">__
                                        </router-link>
                                    </li>
                                 </ol>
                          </li>
                          <li>
                             ...
                             <li>
                                ...
                                <ol class="subMenuItem">
                                    ...
                                    <li>
                                        <router-link to='/CCIE/agencyDisposal'>
                                         已处置报关单清单
                                        </router-link>
                                    </li>
                                 </ol>
            ...
            <div class="top">
                <!-- <div class="header-logo">
                  <img src="@/assets/ccie-logo2.png" alt="">
                </div> -->
                <a style="width: 10%">
        ...
        <div class="body" v-if="menuShow">
            <div class="container" >
              <div class="navTab">
                <div class="after" @click="taggleShow"></div>
                <nav-tab :routePath='menuList' :indexActive="indexActive" :childIndexActive="childIndexActive"></nav-tab> 
              </div>
              <div id='log' @click='showLog'></div>
              <div id='showUser'>
                <img :src= imgSrc alt="" @click="goUser">
              </div>
              <div class="outlet">
                <img src="@/assets/ccie-common-background.png" class="bgImg" alt="">
                <div class="view">
                  <span class="contentTile" v-if="viewTitle">{{viewTitle}}</span>
                  <div>
              ...
              <div style="text-align: center">开发单位:全国海关大数据云平台（上海）&nbsp;&nbsp;全国海关大数据应用中心</div>
            </div>
        </div>
         <div class="CCIE-body" v-else>
            <div class="bgcimg">
            <div class="bgc"></div>
            <div class="jt"></div>
            <div class="ciie"></div>
          ...
          <!-- <div class="contanier">
            <div class="left top item">
              <div @click="goRoute('0','exhibitionMapNew')" >
            ...
            <div class="left bottom item">
              <div @click="goRoute('1','proofApprove')">
                  <img src="@/assets/ccie-enter-border.png" alt="">
            ...
            <div class="right top item">
              <div @click="goRoute('2','rangerRecord')">
                  <img src="@/assets/ccie-enter-border.png" alt="">
            ...
            <div class="right bottom item">
              <div @click="goRoute('3','agentCensus')">
                <img src="@/assets/ccie-enter-border.png" alt="">
...
import { getCookie, setCookie,removeCookie } from "@/until/getToken";
    ...
    child: [
      {
        ...
        child: [
          ...
          // {text: "入境人员检疫分析",isA: false,src: '/CCIE/ciieEntryQua'},
        ]
      },
      {
        text: "展中监管",
        child: [
          ...
          { text: "展商咨询受理", isA: false, src: "/CCIE/consultRecord" },
        ]
      },
      {
        text: "展后处置",
        child: [
              ...
              { text:'已处置报关单清单',isA:false, src:'/CCIE/agencyDisposal'},
            ]
      }
    ]
  },
...
export default {
  ...
  methods: {
    goUser(){
      this.imgSrc = require('./img/user.png')
    ...
    loginOut() {
      waterMark.set('')
      setCookie('newUserName','') 
      setCookie('newdeviceMac','')
      setCookie('newdeviceIp','')
      setCookie('newofficeAddr','') 
      setCookie('newofficeName','') 
      axios({
        method: "post",
