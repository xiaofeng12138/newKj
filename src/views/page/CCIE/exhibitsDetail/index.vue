<template>
    <div >
        ...
        <div class="myIndex" style="text-align:left">
            ...
            <!--详情-->
            <Modal v-model="detailDataModel" width="1200"  :mask-closable="false" style="color:#000;">
                <p slot="header" style="text-align:center;background:#fff">
                    <span>List of Overseas Exhibits {{this.titleDate}}中国国际进口博览会进境物资清单</span>
                </p>
                <div style="text-align:center;background:#fff;color:#000">
                    <detail-table :basis="basis" class='detail' :basis2="basis2" :basisBody = 'basisBody'  :positionList = "positionList" @changeData='myChangeData'
...
<script>
    ...
    import detailTable from '../components/detail/exhibitsDetailTable'
