<template>
    <div class="pageBreakBefore myIndex myIndex2" v-bind:class="{printCss:isPrintCss}">
        ...
        <div class="tablePane" style="margin-bottom: 20px">
            <Row v-if="!isPrintCss" style="text-align: left;margin:10px 0;" :class="{inputHasBorder:true,needStar:!disableStatus}">展品类别：
        ...
        <div class="tablePane" >
            ...
            <Table :columns="detailColumns" :data="basisBody" border  width="100%"></Table>
            <!-- 打印时候的位置 -->
