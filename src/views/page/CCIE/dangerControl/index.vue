<template>
<div>
    <!-- <h2 v-if="role==='ROLE_DC'">危险化学品风险监控</h2> -->
...
export default {
    ...
    methods:{
        query(pageNum){
            ...
            var url;
            url=interfaceUrl.queryMaterialsExamineDanger;
        ...
        bukong(){
            var url,temp;
                    ...
                    url=interfaceUrl.queryMaterialsExamineDangerNoPage;
                            temp.dangerHandle='3';
        ...
        unConfirm(){
            ...
            paramTemp.dangerHandle='0';url=interfaceUrl.queryMaterialsExamineDangerNoPage;
        ...
        confirm(){
            ...
            delete paramTemp.pageSize
            delete paramTemp.currPage
            paramTemp.dangerHandle='2';url=interfaceUrl.queryMaterialsExamineDangerNoPage;
