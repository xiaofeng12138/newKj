    ...
    <div>
        <div class="vague" @click="stopEvent">
            <div class="vague-search">
                 <Input v-model="selectValue" size='large' class="customInput" :placeholder="placeHolder" style="width: 100%"   @on-change="remote"></Input>
            </div>
...
<style lang="scss" scoped>
    .vague{
        ...
        &::-webkit-scrollbar-thumb {
            ...
            outline: #044982 solid 1px;
            border-radius: 20px;
        }
        &::-webkit-scrollbar-track {
            box-shadow: inset 0 0 6px #044982;
        }     
        }
