<template>
    <div>
        ...
        <Row :gutter="16">
            ...
            <Col :span=3 >
                <Select v-model="placePosition" size='large' class="customSelect" style="width:100%" clearable  placeholder="请选择展馆号">
                    <Option v-for="item in optionsNum" :value="item" :key="item">{{ item}}</Option>
                </Select>
            </Col>
            <Col :span=10  style="line-height:36px">
                <Col :span=8>
                    <span style="font-size:14px;color:#fff">是否是世界500强及行业龙头：</span>
                </Col>
