...
export default {
  ...
  methods: {
    query(pageNum) {
      ...
      var url;
      url = interfaceUrl.queryMaterialsExamineRadiation;
            ...
            return h("div", [
              h(
                "RadioGroup",
                {
                  props: {
                    value:
                      params.row.RADIATION_HANDLE == "3"
                        ? "布控"
                        : params.row.RADIATION_HANDLE == "0"
                          ? ""
                          : params.row.RADIATION_HANDLE == "1" ? "布控" : "确认"
                  },
                  on: {
                    "on-change": e => {
                      ...
                      this.tempLists[params.index] = {
                        ...
                        radiationHandle:
                          params.row.RADIATION_HANDLE == "1" ? "3" : "2",
                        radiationResult: ""
                      };
                      console.log();
          ...
          render: (h, params) => {
            return h("div", [
              h(
                ...
                params.row.RADIATION_RESULT == 0
                  ? ""
                  : params.row.RADIATION_RESULT
              ),
              h("Input", {
                props: {
                  value:
                ...
                on: {
                  "on-blur": e => {
                    ...
                    this.tempLists[params.index]["RADIATION_RESULT"] =
                      e.target.value;
                      ...
                      data: [
                        {
                          itemuuid: params.row.ITEMUUID,
                          radiationHandle: "3",
                          radiationResult: e.target.value
                        }
                      ]
                    }).then(r => {
                      if (r.code === "200") {
    ...
    bukong() {
      ...
      url = interfaceUrl.queryMaterialsExamineRadiationNoPage;
